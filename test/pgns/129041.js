module.exports = [
  {
    expected: {
      ...
      fields: {
        ...
        RAIM: 'not in use',
        'Time Stamp': 'Manual input mode',
        'AtoN Type': 'Fixed beacon: port hand',
        'Off Position Indicator': 'No',
        'Virtual AtoN Flag': 'Yes',
        'Assigned Mode Flag': 'Autonomous and continuous',
        Spare: 0,
        'Position Fixing Device Type': 'Surveyed',
        Reserved1: 0,
        'AtoN Status': 0,
        'AIS Transceiver information': 'Channel A VDL reception',
        Reserved2: 0,
        'AtoN Name': 'SC',
        'Position Reference from True North Facing Edge': null,
        'Position Reference from Starboard Edge': null,
        'Length/Diameter': null,
        'Beam/Diameter': null
      },
