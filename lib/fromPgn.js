    ...
    if ( postProcessor ) {
      ...
      if ( field.Resolution && typeof value === 'number' ) {
        ...
        if ( typeof field.RangeMin !== 'undefined' && value < field.RangeMin ) {
          value = null
        } else if ( typeof field.RangeMax !== 'undefined' &&
                    value > field.RangeMax ) {
          value = null
        }

        //hacks to deal with 129029 that has errors. Need to handle errors properly!!??
        else if ( field.PhysicalQuantity === 'GEOGRAPHICAL_COORDINATE' &&
                  typeof field.RangeMax !== 'undefined' &&
                  field.BitLength == 64 &&
                  value === field.RangeMax ) {
          value = null
        } else if ( field.PhysicalQuantity === 'DISTANCE' &&
                    typeof field.RangeMax !== 'undefined' &&
                    field.BitLength == 64 &&
                    value == field.RangeMax ) {
          value = null
