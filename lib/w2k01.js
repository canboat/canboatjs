...
const { pgnToActisenseN2KAsciiFormat, actisenseToN2KAsciiFormat } = require('./toPgn')
...
W2K01Stream.prototype.sendString = function (msg) {
  debug('sending %s', msg)
...
W2K01Stream.prototype.sendW2KPGN = function (msg) {
  if ( this.format === N2K_ASCII ) {
    actisenseToN2KAsciiFormat(msg).forEach(raw => {
      this.sendString(raw + '\r\n')
    })
  } else {
  }
