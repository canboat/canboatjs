...
function organizePGNs(byId=false) {
  const res = {}
...
const organizedIDs = organizePGNs(true)
const getPgn = pgn => organizedPGNs[pgn]
const getPgn0 = flow(getPgn, first)
const getPgnById = id => organizedIDs[id]
const customPgns = {}
