...
const { keys, padCharsStart, trimChars } = require('lodash/fp')
...
module.exports.trimWrap = trimChars('()<>[]')
module.exports.rmChecksum = str => str.contains('*') ? str.split('*', 1)[0] : str
module.exports.byteString = (data, separator = ',') => (
  new Uint32Array(data)
  .map(x => padCharsStart('0', 2, x.toString(16)))
  .join(separator)
)
