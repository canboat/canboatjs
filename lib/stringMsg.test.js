...
describe('encodeYDRAW', () => {
  test('long msg', () => {
    expect(encodeYDRAW(parsePDGY(pdgyLong))).toEqual([
      "0df80502 00 2f 51 9f 45 7d 1f 9b",
      "0df80502 01 23 ff ff ff ff ff ff",
      "0df80502 02 ff 7f ff ff ff ff ff",
      "0df80502 03 ff ff 7f ff ff ff ff",
      "0df80502 04 ff ff ff 7f 00 fc 00",
      "0df80502 05 88 13 88 13 00 00 00",
      "0df80502 06 00 01 00 00 00 00 ff",
    ])
  })
})
